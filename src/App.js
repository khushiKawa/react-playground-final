...
function App() {
  ...
  return (
    <React.Fragment>  
    <div className="cont" onMouseUp={lightModeHandler} onMouseDown={darkModeHandler} tabIndex={-1}>
    <div className="App" >
      <UserMain userClass={userClass} userName={userName} userPosition={userPosition}></UserMain>
      <Card enterClassHandler={enterClassHandler} onSubmit={submitHandler} classVal={cardClass}
       nameChangeHandler={nameChangeHandler} positionChangeHandler={positionChangeHandler}
       inputFocusHandler={inputFocusHandler} inputClass={inputClass} inputBlurHandler={inputBlurHandler}></Card>
      <Events eventsClassHandler={eventsClassHandler} eventsClass={eventsClass}></Events>  
    </div>
    <div className="usersCont">
      <UserMini users={users}/>
    </div>
     <div className="cite">
     <a href="https://icons8.com/icon/46920/user-manual">User Manual icon by Icons8</a>
     </div>
    </div>
    </React.Fragment>
